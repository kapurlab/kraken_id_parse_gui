...
if __name__ == "__main__": # execute if directly access by the interpreter
    ...
    parser.add_argument('-b', '--bam', action='store', dest='bam', required=False, default=None, help='Optional: gbk to annotate VCF file')
    parser.add_argument('-c', '--vcf', action='store', dest='vcf', required=False, default=None, help='Optional: gbk to annotate VCF file')
